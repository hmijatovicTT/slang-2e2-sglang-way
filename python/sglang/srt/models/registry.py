...
# --- TT-Metal model registration (hardcoded) ---
try:
    import ttnn
    from sglang.srt.models.tt_llama import TTLlamaForCausalLM
    

    ModelRegistry.models["LlamaForCausalLM"] = TTLlamaForCausalLM
    logger.info("Overwriting LlamaForCausalLM with TTLlamaForCausalLM for TT-Metal")
except ImportError as e:
    logger.warning(f"Failed to register TTLlamaForCausalLM: {e}")
    pass
# --- end TT-Metal model registration ---
